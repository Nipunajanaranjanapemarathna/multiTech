      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Ready to start your vitality journey? We're here to help you
            discover the perfect ElixirX experience.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="backdrop-blur-sm bg-white/5 rounded-3xl p-8 border border-white/10">
            <h3 className="text-2xl font-serif mb-6 text-lime-400">
              Send us a Message
            </h3>
          ...
          <div className="space-y-8">
            ...
            <div className="backdrop-blur-sm bg-white/5 rounded-3xl p-8 border border-white/10">
              ...
              <p className="text-white/60 mt-4 text-sm">
                Join our community and stay updated on the latest wellness tips
                and ElixirX news!
              </p>
            </div>
          </div>
